...
{
    public class ASSpawner : ModItem
    {
        public int Amount = 1;
        public Color TextColor = new(153, 0, 0);
        public string bossname = Language.GetTextValue($"Mods.CalamityMod.NPCs.AquaticScourgeHead.DisplayName");
        ...
        public override bool? UseItem(Player player)/* tModPorter Suggestion: Return null instead of false */
        {
            ...
            else
            {
                ...
                {
                    int idx = NPC.NewNPC(null, (int)player.Center.X - 600, (int)player.Center.Y, ModContent.NPCType<AquaticScourgeHead>(), 1);
                }
        ...
        {
            Color color = ToastyQoLUtils.TwoColorPulse(Color.PeachPuff, Color.MediumSeaGreen, 2);
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<CalamityMod.Items.SummonItems.Seafood>(), 1);
