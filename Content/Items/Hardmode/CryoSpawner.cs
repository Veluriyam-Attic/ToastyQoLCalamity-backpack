...
namespace ToastyQoLCalamity.Content.Items.Hardmode
{
    public class CryoSpawner : ModItem
    {
        ...
        public string bossname = Language.GetTextValue($"Mods.CalamityMod.NPCs.Cryogen.DisplayName");
        ...
        {
            Color color = ToastyQoLUtils.TwoColorPulse(Color.LightBlue, Color.CornflowerBlue, 2);
