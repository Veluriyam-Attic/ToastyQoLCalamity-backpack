...
{
    public class ALSpawner : ModItem
    {
        public int Amount = 1;
        public Color TextColor = new(153, 0, 0);
        public string bossname = Language.GetTextValue($"Mods.CalamityMod.Items.Lore.LoreLeviathanAnahita.DisplayName");
        ...
        public override bool? UseItem(Player player)/* tModPorter Suggestion: Return null instead of false */
        {
            ...
            else
            {
                ...
                {
                    int idx = NPC.NewNPC(null, (int)player.Center.X - 600, (int)player.Center.Y, ModContent.NPCType<Anahita>(), 1);
                }
        ...
        {
            Color color = ToastyQoLUtils.TwoColorPulse(Color.LightSteelBlue, Color.MediumSpringGreen, 2);
