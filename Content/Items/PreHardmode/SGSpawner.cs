...
{
    public class SGSpawner : ModItem
    {
        public int Amount = 1;
        public Color TextColor = new(153, 0, 0);

        public string bossname = Language.GetTextValue($"Mods.CalamityMod.NPCs.SlimeGodCore.DisplayName");

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Slime God Spawner");
            /* Tooltip.SetDefault("Instantly summons Slime God.\n" +
        ...
        public override bool? UseItem(Player player)/* tModPorter Suggestion: Return null instead of false */
        {
            ...
            else
            {
                ...
                {
                    int idx = NPC.NewNPC(null, (int)player.Center.X - 600, (int)player.Center.Y, ModContent.NPCType<SlimeGodCore>(), 1);
                }
        ...
        {
            Color color = ToastyQoLUtils.TwoColorPulse(Color.MediumPurple, Color.Salmon, 2);
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<CalamityMod.Items.SummonItems.OverloadedSludge>(), 1);
