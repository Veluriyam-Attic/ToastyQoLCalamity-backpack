...
{
    public class CrabSpawner : ModItem
    {
        public int Amount = 1;
        public Color TextColor = new(153, 0, 0);

        public string bossname = Language.GetTextValue($"Mods.CalamityMod.NPCs.Crabulon.DisplayName");


        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Crabulon Spawner");
            /* Tooltip.SetDefault("Instantly summons Crabulon.\n" +
        ...
        public override bool? UseItem(Player player)/* tModPorter Suggestion: Return null instead of false */
        {
            ...
            else
            {
                ...
                {
                    int idx = NPC.NewNPC(null, (int)player.Center.X - 600, (int)player.Center.Y, ModContent.NPCType<Crabulon>(), 1);
                }
        ...
        {
            Color color = ToastyQoLUtils.TwoColorPulse(Color.PapayaWhip, Color.SkyBlue, 2);
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<CalamityMod.Items.SummonItems.DecapoditaSprout>(), 1);
