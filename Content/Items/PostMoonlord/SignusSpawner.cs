...
namespace ToastyQoLCalamity.Content.Items.PostMoonlord
{
    public class SignusSpawner : ModItem
    {
        ...
        public string bossname = Language.GetTextValue($"Mods.CalamityMod.NPCs.Signus.DisplayName");
        ...
        public override bool? UseItem(Player player)/* tModPorter Suggestion: Return null instead of false */
        {
            ...
            else
            {
                ...
                {
                    int idx = NPC.NewNPC(null, (int)player.Center.X - 600, (int)player.Center.Y, ModContent.NPCType<Signus>(), 1);
                }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<CalamityMod.Items.Materials.CoreofHavoc>(), 5);
