...
namespace ToastyQoLCalamity.Content.Items.PostMoonlord
{
    public class PolterSpawner : ModItem
    {
        ...
        public string bossname = Language.GetTextValue($"Mods.CalamityMod.NPCs.Polterghast.DisplayName");
        ...
        {
            Color color = ToastyQoLUtils.TwoColorPulse(Color.PowderBlue, Color.SlateBlue, 2);
