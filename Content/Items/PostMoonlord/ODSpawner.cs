...
namespace ToastyQoLCalamity.Content.Items.PostMoonlord
{
    public class ODSpawner : ModItem
    {
        ...
        public string bossname = Language.GetTextValue($"Mods.CalamityMod.NPCs.OldDuke.DisplayName");
        ...
        {
            Color color = ToastyQoLUtils.TwoColorPulse(Color.Peru, Color.SaddleBrown, 2); ;
