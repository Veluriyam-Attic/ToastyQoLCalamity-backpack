...
{
    public class YharonSpawner : ModItem
    {
        public int Amount = 1;
        public Color TextColor = new(153, 0, 0);
        public string bossname = Language.GetTextValue($"Mods.CalamityMod.NPCs.Yharon.DisplayName");
        ...
        public override bool? UseItem(Player player)/* tModPorter Suggestion: Return null instead of false */
        {
            ...
            else
            {
                ...
                {
                    int idx = NPC.NewNPC(null, (int)player.Center.X - 600, (int)player.Center.Y, ModContent.NPCType<Yharon>(), 1);
                }
        ...
        {
            Color color = ToastyQoLUtils.TwoColorPulse(new Color(255, 165, 0), new Color(255, 140, 0), 2);
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<CalamityMod.Items.SummonItems.YharonEgg>(), 1);
