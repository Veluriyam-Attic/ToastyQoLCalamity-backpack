...
{
    public class EThanosSpawner : ModItem
    {
        public int Amount = 1;
        public Color TextColor = new(153, 0, 0);

        public string bossname = Language.GetTextValue($"Mods.CalamityMod.NPCs.ThanatosHead.DisplayName");

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("XM-05 Thanatos Spawner");
            /* Tooltip.SetDefault("Instantly summons XM-05 Thanatos.\n" +
        ...
        public override bool? UseItem(Player player)/* tModPorter Suggestion: Return null instead of false */
        {
            ...
            else
            {
                ...
                {
                    int idx = NPC.NewNPC(null, (int)player.Center.X, (int)player.Center.Y + 2000, ModContent.NPCType<ThanatosHead>(), 1);
                }
        ...
        {
            Color color = ToastyQoLUtils.TwoColorPulse(new Color(105, 105, 105), new Color(0, 140, 255), 2);
