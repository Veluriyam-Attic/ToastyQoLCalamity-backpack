...
{
    public class DoGSpawner : ModItem
    {
        public int Amount = 1;
        public Color TextColor = new(153, 0, 0);

        public string bossname = Language.GetTextValue($"Mods.CalamityMod.NPCs.DevourerofGodsHead.DisplayName");

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Devourer Of Gods Spawner");
            /* Tooltip.SetDefault("Instantly summons Devourer Of Gods.\n" +
        ...
        public override bool? UseItem(Player player)/* tModPorter Suggestion: Return null instead of false */
        {
            ...
            else
            {
                ...
                {
                    int idx = NPC.NewNPC(null, (int)player.Center.X - 600, (int)player.Center.Y, ModContent.NPCType<DevourerofGodsHead>(), 1);
                }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<CalamityMod.Items.SummonItems.CosmicWorm>(), 1);
